...
def get_interface_and_mac_args() -> (str, str):
    ...
    group.add_argument("-rm", "--randmac", dest = "random_mac_address", action = "store_true", help = "New random MAC address")
...
def get_current_mac_address(interface: str) -> str:
...
def display_current_mac_address(current_mac_address: str) -> None:
...
def check_if_changed_mac_address(interface: str, new_mac_address: str) -> None:
...
def run_mac_changer_engine() -> None:
